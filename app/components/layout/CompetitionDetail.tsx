...
export default function CompetitionDetail({ competitionWithPrizes }) {
  ...
  return (
    <div className="max-w-lg mx-auto bg-[#18181b] rounded-2xl shadow-lg overflow-hidden text-white p-0">
      {/* Image */}
      ...
      <div className="flex items-center gap-2 mt-4 ml-4">
        <span className="bg-[#232326] text-[#E19841] px-4 py-1 rounded-full flex items-center text-sm font-semibold">
      ...
      <div className="px-6 mb-2">
        <div className="flex justify-between text-xs mb-1">
          <span className="text-gray-300">{ticketsLeft} Tickets Left</span>
          <span className="text-gray-300">
            {ticketsSold}/{totalTickets}
          </span>
        </div>
        <Progress value={progress} className="h-4 bg-[#232326] rounded-full" />
        ...
        <div className="grid grid-cols-3 gap-2">
          {quickSelect.map((num) => (
            <button
              ...
              className={`w-full px-4 py-2 rounded-lg font-bold text-lg border-2 ${
                ticketCount === num
                  ? "bg-[#E19841] text-black border-[#E19841]"
                  : "bg-[#232326] text-white border-[#232326]"
              } transition-colors`}
            >
              {num}
            </button>
      ...
      <div className="px-6 mt-2 mb-2">
        <div className="flex items-center gap-4">
          ...
          />
          <span className="bg-[#232326] px-3 py-1 rounded-lg font-bold text-lg">
            {ticketCount}
          </span>
        </div>
      ...
      <div className="px-6 mt-2 mb-2">
        <div className="bg-[#232326] text-[#E19841] rounded-lg px-4 py-2 font-bold text-center">
