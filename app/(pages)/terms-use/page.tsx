        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <p>
              ...
              changes to our products, services, our users&apos; needs and our
              business priorities.
            </p>
            ...
            <p>
              ...
              other users of the site, including posts made to our social media
            ...
            <p>
              ...
              a limited licence to use, store and copy that content and to
              distribute and make it available to third parties. The rights you
              license to us are described below.
            </p>
            <p>
            ...
            <p>
              ...
              licence to use, reproduce, distribute, prepare derivative works
              of, display, and perform that user-generated content. We may also
              share it, quote from it and use it to promote our site, products
              and services, particularly via social media.
            </p>
            ...
            <p>
              ...
              England and Wales will have exclusive jurisdiction to deal with
