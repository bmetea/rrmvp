    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          www.radiancerewards/acceptableusepolicy.co.uk (our site). This
          acceptable use policy applies to all users of, and visitors to, our
          site.
        </p>
        <p className="mb-4">
          Your use of our site means that you accept, and agree to abide by, all
          the policies in this acceptable use policy, which supplement our terms
        ...
        <p className="mb-4">
          To contact us, please email hello@radiancerewards.co.uk.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          example, the ability to participate in games, competitions, comment on
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Contributions must:</p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <p className="mb-4">Contributions must not:</p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          of this acceptable use policy through your use of our site. When a
          breach of this policy has occurred, we may take such action as we deem
          appropriate.
        </p>
        <p className="mb-4">
