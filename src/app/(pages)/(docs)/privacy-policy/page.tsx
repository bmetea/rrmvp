          ...
          <Card>
            ...
            <CardContent>
              <div className="prose prose-gray max-w-none">
                ...
                <p>Welcome to Claravue Ltd&apos;s privacy policy.</p>
                <p>
                  Claravue Ltd respects your privacy and is committed to
                  protecting your personal data. This privacy policy will inform
                  you as to how we process and look after your personal data
                  when you visit our website (regardless of where you visit it
                  from).
                </p>
                <p>
                ...
                <p>You can download a pdf version of the policy here.</p>
                <p>
                ...
                <p>
                  ...
                  Claravue Ltd collects and processes your personal data through
                  your use of this website, including any data you may provide
                  through this website when you sign up to our newsletter,
                  purchase any products or services or take part in a prize draw
                  or competition.
                </p>
                <p>
                ...
                <p>
                  Claravue Ltd is the controller and responsible for your
                  personal data (collectively referred to as
                  [&quot;Claravue&quot;], &quot;we&quot;, &quot;us&quot; or
                ...
                <h3 className="text-lg font-bold mt-6 mb-3">Contact details</h3>
                <p>
                ...
                <p>
                  ...
                  was last updated on 14th April 2025.
                </p>
                <p>
                ...
                <p>
                  ...
                  you to enter into any prize draw and competition and allow us
                  to run the promotion. If you are a winner, it may be necessary
                  to collect more detailed information from you in order to
                  award your prize to you. You will be notified of this at the
                  time we notify you if you have won.
                </p>
                ...
                <p>
                  ...
                  example, to provide you with goods or services or to enter you
                  into a competition). In this case, we may have to cancel a
                  product or service you have with us or refuse your entry to a
                  competition. We will notify you if this is the case at the
                  time.
                </p>
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    ...
                    employing our cookies. Please see our cookie policy for
                    further details.
                  </li>
                  <li>
                    <strong>
                    ...
                    <ul className="list-disc pl-6 mt-2">
                      <li>
                        <strong>Advertising & Remarketing:</strong> Facebook
                        Audience Network & Lookalike Audience, Google Ad Manager
                      </li>
                      <li>
                        <strong>Analytics:</strong> Facebook Pixel, Google
                        Analytics
                      </li>
                      <li>
                        <strong>Infrastructure & Security:</strong> Amazon Web
                        Services (AWS), Google reCAPTCHA, Google Tag Manager
                      </li>
                      <li>
                        <strong>Contacting Users:</strong> Klaviyo, user.com
                      </li>
                      <li>
                        Contact, Financial and Transaction Data from providers
                        of technical, payment and delivery services such as
                        Stripe, Apple Pay or Paypal
                      </li>
                      <li>
                  ...
                  <table className="min-w-full border-collapse">
                    <thead>
                      <tr className="border-b">
                        <th className="text-left p-2">Purpose/Activity</th>
                        <th className="text-left p-2">Type of data</th>
                    ...
                    <tbody>
                      <tr className="border-b">
                        ...
                        <td className="p-2">(a) Identity (b) Contact</td>
                        <td className="p-2">
                      ...
                      <tr className="border-b">
                        <td className="p-2">
                          To process and deliver your order including: (a)
                          Manage payments, fees and charges (b) Collect and
                        ...
                        <td className="p-2">
                          ...
                          for our legitimate interests (to recover debts due to
                          us)
                        </td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2">
                          ...
                          include: (a) Notifying you about changes to our terms
                          or privacy policy (b) Asking you to leave a review or
                          take a survey
                        </td>
                        <td className="p-2">
                      ...
                      <tr className="border-b">
                        ...
                        <td className="p-2">
                          ...
                          use our products/services, to develop them and grow
                          our business)
                        </td>
                      </tr>
                      <tr className="border-b">
                      ...
                      <tr className="border-b">
                        ...
                        <td className="p-2">(a) Technical (b) Usage</td>
                        <td className="p-2">
                ...
                <p>
                  ...
                  competition. Your participation is not compulsory but would be
                  greatly appreciated by us. If you do not wish to participate
                  your participation in the competition or chances of winning
                ...
                <p>
                  ...
                  requirement we must comply with. If you require detail of how
                  the ASA will use and process your personal data, please let us
                  know.
                </p>

                <h3 className="text-lg font-bold mt-6 mb-3">Marketing</h3>
                <p>
                ...
                <p>
                  ...
                  from us, entered a competition or prize draw and you have not
                ...
                <p>
                  ...
                  for the purposes set out in the table &quot;Purposes for which
                  we will use your personal data&quot; above.
                </p>
                <ul className="list-disc pl-6 mb-4">
                  <li>External Third Parties as set out in the Glossary.</li>
                  <li>
                    Specific third parties listed in the table &quot;Purposes
                ...
                <h2 className="text-xl font-bold mt-8 mb-4">10. Glossary</h2>
                <h3 className="text-lg font-bold mt-6 mb-3">LAWFUL BASIS</h3>
                <p>
                ...
                <h3 className="text-lg font-bold mt-6 mb-3">THIRD PARTIES</h3>
                <p>
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    HM Revenue & Customs, regulators and other authorities such
                    as the Advertising Standards Authority acting as processors
                    or joint controllers based in the United Kingdom who require
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    ...
                    processing carried out before you withdraw your consent. If
