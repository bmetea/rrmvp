...
function CompetitionDetailImpl({ competitionWithPrizes }) {
  ...
  return (
    <div className="max-w-7xl mx-auto py-4 lg:py-8 px-4">
      ...
      {/* Mobile Content Card */}
      <div className="lg:hidden bg-white dark:bg-[#18181b] rounded-xl shadow-lg p-4">
        {/* Progress Bar */}
        <div className="mb-4">
          <div className="flex justify-between text-xs mb-1">
            <span className="text-gray-500 dark:text-gray-300">
        ...
        {/* Quick Ticket Selection */}
        <div className="mb-4">
          <label className="block font-bold text-sm mb-2">Select Tickets</label>
          <div className="grid grid-cols-3 gap-2">
            {quickSelect.map((num) => (
              <button
                key={`quick-select-${num}`}
        ...
        <Link
          href="/free-postal-entry"
          className="block text-center text-[#E19841] hover:text-[#D18A33] font-medium text-sm mb-6"
        >
          Free Postal Entry Available
        </Link>
